...
This project is indexed by GitNexus as **meridian** (2374 symbols, 5486 relationships, 203 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

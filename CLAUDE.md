...
This project is indexed by GitNexus as **meridian** (2402 symbols, 5586 relationships, 205 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

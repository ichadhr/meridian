...
export const TIMEFRAME_SCREENING_SCALES: Record<string, ScreeningScale> = {
  ...
  "4h":  { minFeeActiveTvlRatio: 0.8,  minVolume: 40_000 },
...
export function getScreeningDefaultsForTimeframe(timeframe: string | null | undefined): { timeframe: string } & ScreeningScale {
...
export function scaleScreeningToTimeframe(timeframe: string | null | undefined): ScreeningScale {

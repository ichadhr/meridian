// test/test-dry-run-cache.js
// Step 4 of meridian-wie: DRY_RUN cache TTL is shorter (10s) so paper trading
// shows fresh PnL between management cycles, while still throttling
// rapid-fire /positions calls. Live mode keeps 5-min TTL unchanged.
//
...
function restoreDryRun(original) {
